...
namespace cs22_collection
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            char[] oldString = new char[5]; // 조선시대방법 문자열의 길이를 지정해야함
            string curString = "";  // 문자열의 길이 제한 없음
            ...
            list.Add(4);
            list.Add(5);
            list.Add(6); // 위의 있는 배열과 차이점 원소 입력에 제한이 없음
            ...
            //ArrayList .Add(), .Insert(x, val), .Remove(val), .RemoveAt(x)위치값제거, .Sort(), .Reverse()
