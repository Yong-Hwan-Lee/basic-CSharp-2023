...
namespace wf03_property
{
    public partial class FrmMain : Form
    {
        ...
        {
            GbxMain.Text = "컨트롤 학습";
            var fonts = FontFamily.Families.ToList(); //내 os 폰트이름가져오기
            ...
            //텍스트박스 초기화
            txtResult.Text = "Vamos, WinForms!!";

            NudFontSize.Value = 9; // 글자체 크기를 9로 지정
        }
        /// <summary>
        /// 글자 스타일, 크기 , 폰트 글자체를 변경해주는 메서드
        /// </summary>
        ...
        private void BtnModal_Click(object sender, EventArgs e)
        {
            ...
            frm.ShowDialog();   // 모달 방식으로 새 자식창띄우기 
        }
        ...
        private void BtnAddChild_Click(object sender, EventArgs e)
        {
            if (TrvDummy.SelectedNode != null)
            {
                ...
                TrvDummy.SelectedNode.Expand();     // 트리 노드 하위것 펼쳐주기/반대 = Collapse
                TreeToList();
            }
        }
        ...
        void TreeToList()
        {
            LsvDummy.Items.Clear(); // 리스트뷰, 트리뷰 모든 아이템을 제거, 초기화
