...
namespace cs19_interface
{
    ...
    {
        void WriteLog(string format, params object[] args); // args 다중파라미터
    }

    class ConsoleLogger : ILogger    // WirteLog도 무조건 가져와야함(약속을하는게 인터페이스)
    {
    ...
    // C#에는 다중상속불가능 대신 인터페이스
    class FlyHoverCar : Car, IHoverable, IFlyable
    {
        public void Fly()
        {
