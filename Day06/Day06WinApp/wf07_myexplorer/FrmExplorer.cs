...
using System.Data;
using System.Diagnostics;       //Process 클래스객체
...
namespace wf07_myexplorer
{
    public partial class FrmExplorer : Form
    {
        ...
        private void FrmExplorer_Load(object sender, EventArgs e)
        {
            ...
            LsvFolder.Columns.Add("유형", (LsvFolder.Width /7),HorizontalAlignment.Left);
            LsvFolder.Columns.Add("크기", (LsvFolder.Width /9),HorizontalAlignment.Right);
        ...
        private void FillNodes(TreeNode curNode)
        {
            ...
            {
                MessageBox.Show("트리오류 발생!", "오류", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void TrvDrive_BeforeExpand(object sender, TreeViewCancelEventArgs e)
        {
            if (e.Node.Nodes[0].Text == "*")
            {
                ...
                e.Node.SelectedImageIndex = 2;      //folder-oepn
        ...
        private void CboView_SelectedIndexChanged(object sender, EventArgs e)
        {
            switch(CboView.SelectedIndex)
            {
                ...
                default: break; //위와같은경우면 default는 없어도됨
